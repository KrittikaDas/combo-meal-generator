...
const generate3DayBtn = document.getElementById('generate3DayBtn'); // Changed ID from generateBtn
const generateWeekBtn = document.getElementById('generateWeekBtn'); // RE-ADDED ID
...
async function fetchAndDisplayCombos(numberOfDays) {
    ...
    // Iterate through each day to fetch its combos
    for (const day of daysToFetch) {
        ...
        try {
            ...
            hasOverallError = true; // Mark that at least one day failed
    ...
    // Display all generated sections (or error messages)
    if (hasOverallError) {
...
// Event listener for the "Show Full Week Plan" button
